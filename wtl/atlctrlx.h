...
// Data members
	...
	int m_xBtnImageLeft;
	int m_yBtnImageTop;
	int m_xBtnImageRight;
	int m_yBtnImageBottom;

// Constructor
	CPaneContainerImpl() : m_cxyHeader(0), m_dwExtendedStyle(0), m_hFont(NULL), m_bInternalFont(false), m_dpi(0)
	{
		m_szTitle[0] = 0;
	}
	...
	void SetDPI( int dpi )
	{
		...
		m_cxyBorder = ScaleX( 2 );
		m_cxyTextOffset = ScaleX( 4 );
		m_cxyBtnOffset = ScaleX( 1 );

		m_cxImageTB = ScaleX( 13 );
		m_cyImageTB = ScaleX( 11 );
		m_cxyBtnAddTB = ScaleX( 7 );

		m_cxToolBar = m_cxImageTB + m_cxyBtnAddTB + m_cxyBorder + m_cxyBtnOffset;

		m_xBtnImageLeft = ScaleX( 6 );
		m_yBtnImageTop = ScaleX( 5 );
		m_xBtnImageRight = ScaleX( 12 );
		m_yBtnImageBottom = ScaleX( 11 );
	}
...
// Methods
	...
	{
		int dpi = MyGetDpiForWindow( hWndParent );
		SetDPI( dpi );
		if(lpstrTitle != NULL)
